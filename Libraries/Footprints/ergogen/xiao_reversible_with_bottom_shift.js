...
(footprint "xiao-ble-tht" (version 20211014) (generator pcbnew)
  ...
  ${p.instructions ? instructions : ""}
    ...
    // Bottom pad Y: the last side-pin row lands at top_left_pin.y + 8*pin_dist = -10.16 + 20.32 = 10.16.
    // The bottom pads share that same Y in the original non-reversible footprint, which is fine there
    // because there are no jumper traces at that row. In the reversible footprint the cross-over traces
    // for row 8 (P8/P14) run through that area, so we shift the bottom pads one pitch further down.
    const bottom_pad_y = 12.7; // 10.16 + 2.54
...
(footprint "xiao-ble-tht" (version 20211014) (generator pcbnew)
  ...
  (fp_rect (start -9 -11.75) (end 9 14.0) (layer "F.SilkS") (width 0.12) (fill none))
  (fp_rect (start -9 -11.75) (end 9 14.0) (layer "B.SilkS") (width 0.12) (fill none))

  ${get_thru_hole()}
  ${get_solder_pads()}

  (pad "18" thru_hole oval (at  5.08 ${bottom_pad_y} ${p.rot + 90}) (size 2.5 1.5) (drill 1 (offset -0.5 0)) (layers *.Cu *.Mask) ${p.P13.str})
  (pad "19" thru_hole oval (at  2.54 ${bottom_pad_y} ${p.rot + 90}) (size 2.5 1.5) (drill 1 (offset -0.5 0)) (layers *.Cu *.Mask) ${p.P12.str})
  (pad "20" thru_hole oval (at  0    ${bottom_pad_y} ${p.rot + 90}) (size 2.5 1.5) (drill 1 (offset -0.5 0)) (layers *.Cu *.Mask) ${p.P11.str})
  (pad "21" thru_hole oval (at -2.54 ${bottom_pad_y} ${p.rot + 90}) (size 2.5 1.5) (drill 1 (offset -0.5 0)) (layers *.Cu *.Mask) ${p.P10.str})
  (pad "22" thru_hole oval (at -5.08 ${bottom_pad_y} ${p.rot + 90}) (size 2.5 1.5) (drill 1 (offset -0.5 0)) (layers *.Cu *.Mask) ${p.P9.str})
