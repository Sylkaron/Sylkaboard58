...
.subtract(
    new CSG.Path2D([[171.3922477,-121.4962764],[185.3922477,-121.4962764]]).appendPoint([185.3922477,-107.4962764]).appendPoint([171.3922477,-107.4962764]).appendPoint([171.3922477,-121.4962764]).close().innerToCAG()
.union(
...
.subtract(
    new CSG.Path2D([[171.3922477,-94.3962764],[185.3922477,-94.3962764]]).appendPoint([185.3922477,-54.3962764]).appendPoint([171.3922477,-54.3962764]).appendPoint([171.3922477,-94.3962764]).close().innerToCAG()
                ...
                function l_compact_uplate_case_fn() {
                    

                // creating part 0 of case l_compact_uplate
                let l_compact_uplate__part_0 = compact_plate_extrude_1_5_outline_fn();

                // make sure that rotations are relative
                let l_compact_uplate__part_0_bounds = l_compact_uplate__part_0.getBounds();
                let l_compact_uplate__part_0_x = l_compact_uplate__part_0_bounds[0].x + (l_compact_uplate__part_0_bounds[1].x - l_compact_uplate__part_0_bounds[0].x) / 2
                let l_compact_uplate__part_0_y = l_compact_uplate__part_0_bounds[0].y + (l_compact_uplate__part_0_bounds[1].y - l_compact_uplate__part_0_bounds[0].y) / 2
                l_compact_uplate__part_0 = translate([-l_compact_uplate__part_0_x, -l_compact_uplate__part_0_y, 0], l_compact_uplate__part_0);
                l_compact_uplate__part_0 = rotate([0,0,0], l_compact_uplate__part_0);
                l_compact_uplate__part_0 = translate([l_compact_uplate__part_0_x, l_compact_uplate__part_0_y, 0], l_compact_uplate__part_0);

                l_compact_uplate__part_0 = translate([0,0,0], l_compact_uplate__part_0);
                let result = l_compact_uplate__part_0;
                
            

                // creating part 1 of case l_compact_uplate
                let l_compact_uplate__part_1 = l_screen_base_case_fn();

                // make sure that rotations are relative
                let l_compact_uplate__part_1_bounds = l_compact_uplate__part_1.getBounds();
                let l_compact_uplate__part_1_x = l_compact_uplate__part_1_bounds[0].x + (l_compact_uplate__part_1_bounds[1].x - l_compact_uplate__part_1_bounds[0].x) / 2
                let l_compact_uplate__part_1_y = l_compact_uplate__part_1_bounds[0].y + (l_compact_uplate__part_1_bounds[1].y - l_compact_uplate__part_1_bounds[0].y) / 2
                l_compact_uplate__part_1 = translate([-l_compact_uplate__part_1_x, -l_compact_uplate__part_1_y, 0], l_compact_uplate__part_1);
                l_compact_uplate__part_1 = rotate([0,0,0], l_compact_uplate__part_1);
                l_compact_uplate__part_1 = translate([l_compact_uplate__part_1_x, l_compact_uplate__part_1_y, 0], l_compact_uplate__part_1);

                l_compact_uplate__part_1 = translate([0,0,0], l_compact_uplate__part_1);
                result = result.union(l_compact_uplate__part_1);
            ...
            function main() {
                return l_compact_uplate_case_fn();
            }
